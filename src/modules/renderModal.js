...
export const renderModal = (parent, data) => {
	...
	const reviewTitle = createElement(
		'h3',
		{
	...
	const formBottom = createElement(
		'div',
		{
	...
	for (let i = 1; i <= 5; i++) {
		rating.innerHTML += `
      <svg class="rating__star" width="18" height="18" viewBox="0 0 18 18" data-rating="2" fill="currentColor"
